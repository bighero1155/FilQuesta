            ...
            <div style={{
              ...
              <button
                onClick={() => {
                  ...
                  window.location.href = `/wordwizard?level=${firstLevelId}&category=${currentSection.categoryId}`;
                }}
                style={{

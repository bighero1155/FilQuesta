...
const MagicTreeMap: React.FC = () => {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: "linear-gradient(180deg, #1a2332 0%, #2d3e50 50%, #1a3a52 100%)",
        padding: "20px",
        fontFamily: "Fredoka, Arial Black, sans-serif",
        position: "relative",
        overflow: "hidden",
    ...
    >
      ...
      <div style={{ 
        ...
        <button
          ...
          style={{
            width: "50px",
            height: "50px",
            background: "linear-gradient(135deg, #0d4a7a, #0a3d5c)",
      ...
      {/* Player Card */}
      <div style={{
        background: "linear-gradient(135deg, #1e3a2f, #1a2332)",
        borderRadius: "20px",
      ...
      <div style={{
        ...
        <div
          style={{
            background: `linear-gradient(135deg, ${currentSection.darkColor}, #1a2332)`,
